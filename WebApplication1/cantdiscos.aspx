...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label3" runat="server" Text="Disco:"></asp:Label>
            &nbsp;
            <asp:DropDownList ID="DropDownList2" runat="server" Height="23px" Width="371px">
        </asp:DropDownList>
&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           <br />
            ...
            &nbsp;
        <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Recuperar C. Disco" Width="147px" />
        <br />
        <asp:DropDownList ID="DropDownList3" runat="server" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged" Width="302px">
        </asp:DropDownList>
