...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        <br />
            <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Eliminar Ubicacion"></asp:Label>
            &nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Recuperar Ubicacion" Width="153px" />
           <br />
           <asp:DropDownList ID="DropDownList3" runat="server" Height="23px" Width="286px">
        </asp:DropDownList>
&nbsp;&nbsp;&nbsp; &nbsp;
