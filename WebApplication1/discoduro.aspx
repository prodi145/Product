...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Recuperar Disco Duro" Width="159px" />
            <br />
&nbsp;
            <asp:DropDownList ID="DropDownList2" runat="server" Height="20px" Width="237px">
            </asp:DropDownList>
&nbsp;
            ...
            <br />
                     <br />
            <br />
            <asp:Button ID="Button2" runat="server" Text="Ver Discos Duros" OnClick="Button2_Click" />
            <br />
            <br />
